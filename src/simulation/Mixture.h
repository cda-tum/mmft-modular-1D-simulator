...
namespace sim {
/**
* @brief Class that defines a liquid mixture that consists of one or multiple fluids in various concentrations.
*/
class Mixture {
  private:
    int const id;                                         ///< Mixture ids
    std::unordered_map<int, double> fluidConcentrations;  ///< Map of fluid ids and fluid concentration values (0.0 to 1.0) that define of what the mixture is made of. Concentrations must sum up to 1.0.
    double viscosity;                                     ///< Viscosity of the mixture in Pas.
    double density;                                       ///< Density of the mixture in kg/m^3.
    double largestMolecularSize;                          ///< Molecular size in m^3.
    int fluidCount;                                       ///< Number of fluids in this mixture.
